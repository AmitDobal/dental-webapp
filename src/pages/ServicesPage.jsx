  ...
  return (
    <>
      <SEO
        ...
        description={`Comprehensive dental services by ${clinicInfo.doctor.name} in Kharghar, Navi Mumbai. From cosmetic dentistry and root canal treatment to dental implants and teeth whitening. Transparent pricing and expert care.`}
        keywords={`dental services Kharghar, cosmetic dentistry, root canal treatment, dental implants, teeth whitening, smile design, preventive dentistry, Dr. Manasi Surwade, Manifest Dental Studio, dental care Navi Mumbai, affordable dental treatment`}
        image="/images/services/general-dentistry.jpeg"
        url="https://manifestdental.com/services"
        type="website"
        pageType="services"
      />
          ...
          <div className="relative z-10 container mx-auto px-4 text-center">
            <motion.div
              ...
              <p className="text-white text-lg sm:text-xl mb-8 leading-relaxed">
                Comprehensive dental care with transparent pricing and
                exceptional quality. From routine cleanings to advanced cosmetic
                procedures, we provide personalized treatment plans tailored to
                your unique needs.
              </p>
          ...
          <div className="container mx-auto px-4">
            <motion.div
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
                Complete <span className="text-white">Treatment Options</span>
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <motion.div
                  ...
                  <p className="text-white text-sm">
                    Dr. Manasi brings years of expertise in cosmetic dentistry
            ...
            <motion.div
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 max-w-3xl mx-auto text-white border border-white/20">
                ...
                <p className="text-white mb-6 text-lg">
                  Schedule a consultation with Dr. Manasi and take the first
                  step towards a healthier, more beautiful smile.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button
                    as="a"
