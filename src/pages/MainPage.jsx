...
const MainPage = () => {
  ...
  return (
    <>
      <SEO
        title="Dr. Manasi's Manifest Dental Studio"
        description={`Expert dental care by ${clinicInfo.doctor.name} in Kharghar, Navi Mumbai. Specializing in cosmetic dentistry, root canal treatment, dental implants, and teeth whitening. Book your appointment today for a healthy, beautiful smile.`}
        keywords={`dental clinic Kharghar, cosmetic dentist Navi Mumbai, root canal specialist, dental implants, teeth whitening, Dr. Manasi Surwade, Manifest Dental Studio, dental care, oral health, smile design, preventive dentistry, Kharghar dental clinic, best dentist Navi Mumbai`}
        image="/images/about/dr-manasi.jpeg"
        url="https://manifestdental.com"
        type="website"
        pageType="home"
      />
