  ...
  return (
    <>
      <SEO
        ...
        description="The page you're looking for cannot be found. Return to Dr. Manasi's Manifest Dental Studio homepage or contact us for assistance."
        keywords={`404 error, page not found, Manifest Dental Studio, Dr. Manasi Surwade, dental clinic Kharghar`}
        image="/images/dental-logo.png"
        url="https://manifestdental.com/404"
        type="website"
        pageType="error"
      />
